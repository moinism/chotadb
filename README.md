...
`localStorage` is massively supported in browsers and devices currently being used and has a storage capacity [ranging from 2MB to 10MB](http://www.html5rocks.com/en/tutorials/offline/quota-research/ target="_blank"). So why not use it in more powerful way!
...
It has been [supported in browsers](https://developer.mozilla.org/en/docs/Web/API/Window/localStorage#Browser_compatibility target="_blank") since:
...
For other web, Cordova & Chrome based projects simply [download](https://raw.githubusercontent.com/moinism/chotadb/master/build/chotadb.min.js target="_blank") and include the file in your pages:
